...
<ul id="clone-ul" style="display: none">
	<li class="list-group-item mb-4">
		<div>
            <span class="float-right mr-4"><small><i>Creado en: <span class="created"></span></i></small></span>
			<a href="" class=" filter-text title"><?php echo $row['title'] ?></a>

		</div>
		<hr>
		<p class="truncate filter-text desc"></p>
		<p class="row justify-content-left"><span class="badge badge-success text-white"><i>Posteado Por: <span class="posted"></span></i></span></p>
		<hr>
		<div class="row">
			<div class="col-lg-12">
				<span class="float-left badge badge-secondary text-white"><span class="views"></span> Visitas</span>
				...
				if(resp){
					...
					if(resp.length > 0){
						...
						Object.keys(resp).map(k=>{
							...
							$('#search_result').html('<h4><b>No se encontraron resultados.</b></h4>')
					}
				}
			}
		})
