...
.imgs{
    ...
    .fotoHome{
        padding-top: 20px;
        background: url(assets/img/fotoHome.JPG);
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4><i class="fa fa-tags text-primary"></i> Categorías</h4>
                    <div class="row fotoHome">
                    <?php
	...
	$('#manage-records').submit(function(e){
        ...
        $.ajax({
            ...
            success:function(resp){
                ...
                if(resp.status==1){
                    alert_toast("Información guardada con éxito",'Éxito')
                    setTimeout(function(){
                        location.reload()
                    },800)
                ...
                success:function(resp){
                    if(resp){
                        ...
                        if(resp.status == 1){
                            ...
                            alert_toast("Id desconocida.",'Error');
                            end_load();
                        }
                    }
                }
