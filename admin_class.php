...
Class Action {
	...
	//establece conexion de base de datos
	...
	function login(){
		//establece una query a la base de datos y si coincide te da la key de acceso
			extract($_POST);		
	...
	//Cierra sesión del usuario y destruye la sesión inutilizando el "token" de sesión
	function logout(){
		session_destroy();
